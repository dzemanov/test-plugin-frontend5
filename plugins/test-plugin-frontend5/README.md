...
Welcome to the test-plugin-frontend5 plugin!
...
1. Add the package in the `packages/app/package.json`
  ...
  ```
  "@janus-idp/backstage-plugin-test-plugin-frontend5": "^0.1.0",
  ```
...
2. Add Route in `packages/app/src/App.tsx`:
  ...
  ```tsx title="packages/app/src/App.tsx"
   ...
   import { PluginPage } from '@janus-idp/backstage-plugin-test-plugin-frontend5';

   <Route path="/test-plugin-frontend5" element={<PluginPage />} />
   ```
...
3. Add your plugin as a Sidebar Item in `packages/app/src/components/Root/Root.tsx`:
  ...
  ```tsx title="packages/app/src/components/Root/Root.tsx"
   /* highlight-add-next-line */
   import { PluginIcon } from '@janus-idp/backstage-plugin-test-plugin-frontend5';
...
5. Start your application from the root directory, and then navigate to [/test-plugin-frontend5](http://localhost:3000/test-plugin-frontend5).
